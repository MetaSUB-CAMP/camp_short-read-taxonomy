...
def test_merge_bracken_outputs():
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        # dbg
        print("test_out/short-read-taxonomy/2_kraken2/merged/bracken_species.tsv", file=sys.stderr)
        ...
        sp.check_output([
            ...
            "-m",
            "snakemake", 
            "test_out/short-read-taxonomy/2_kraken2/merged/bracken_species.tsv",
            "-f", 
            "-j1",
            "--keep-target-files",
            "--configfile",
