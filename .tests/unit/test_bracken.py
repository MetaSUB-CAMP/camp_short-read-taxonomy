...
def test_bracken():
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        # dbg
        print("test_out/short-read-taxonomy/2_kraken2/raw_bracken/zymo_pos_ctrl/species.tsv", file=sys.stderr)
        ...
        sp.check_output([
            ...
            "-m",
            "snakemake", 
            "test_out/short-read-taxonomy/2_kraken2/raw_bracken/zymo_pos_ctrl/species.tsv",
            "-f", 
            "-j1",
            "--keep-target-files",
            "--configfile",
